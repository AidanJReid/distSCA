...
import com.distSCA.service3_calorie.MathServiceGrpc;
...
public class MainGUIApplication2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainGUIApplication2 window = new MainGUIApplication2();
